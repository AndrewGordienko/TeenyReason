"""Deterministic probe-conditioned policy evaluation and ablations."""
...
from ...handoff.message import build_solver_episode_belief, build_solver_episode_expression
from .context import policy_action_value_step, transform_controller_context_input
from .surprise import compute_control_surprise, compute_probe_surprise
