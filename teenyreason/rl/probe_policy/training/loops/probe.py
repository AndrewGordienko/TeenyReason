"""Probe-conditioned PPO training loop."""
...
from .....crawler.probes.explorer import build_probe_planner
from .....crawler.probes.latent import (
...
from ...handoff.audit import build_solver_expression_audit, solver_message_content
from ...handoff.diagnostics import compute_online_future_diagnostics
from ...handoff.message import (
...
from ..evaluation.context import policy_action_value_step
from ..evaluation.surprise import (
    compute_control_surprise,
    compute_probe_surprise,
)
from ..logging import print_probe_episode_status, print_probe_failure, print_solve_event
from ..support.progress import (
    ...
    mix_controller_contexts,
    normalize_full_system_curriculum_schedule,
...
from ..support.sil import compute_sil_loss
