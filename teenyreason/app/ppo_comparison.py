...
from .artifacts import save_dashboard_context
...
def run_ppo_comparison(
    ...
    *,
    ...
    for env_name in env_names:
        ...
        live_trace = LiveTrainingTraceWriter(artifact_dir=artifact_root, enabled=True)
